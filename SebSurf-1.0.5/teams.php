<?php
  ...
  if (isset($team) && !isTeamLeaderOfTeam($con, $_SESSION["username"], $team) && getUserPower($con, $_SESSION["username"]) < 80) {
...
?>
    ...
    <div class="main">
        ...
        <?php
            if (isset($_GET["error"])) {
                if ($_GET["error"] == "c") {
                    echo "<br><p style='color: lime; border: solid green; max-width: 260px; text-align: center; margin: 10px auto; border-radius: 7px;'>Erstellung eingereicht für Team '".$_GET['team']."'!</p>";
                } elseif ($_GET["error"] == "emptyf") {
                    ...
                    echo "<br><p style='color: red; border: solid red; max-width: 260px; text-align: center; margin: 10px auto; border-radius: 7px;'>Es gibt bereits ein Team mit dem Namen '".$_GET['team']."'!</p>";
    ...
    <div class="main">
        ...
        <?php
            ...
            if (isset($_GET["error"])) {
                if ($_GET["error"] == "del") {
                    echo "<br><p style='color: lime; border: solid green; max-width: 260px; text-align: center; margin: 10px auto; border-radius: 7px;'>Anfrage für Team '".$_GET['team']."' zurückgezogen!</p>";
                }
            }
        ?>
    </div>
