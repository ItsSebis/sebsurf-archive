...
if (isset($_POST["member"])) {
    ...
    header("location: ../teams.php?page=requests&error=del&team=".$data["teamname"]);
    exit();
    ...
    if (requestDataByName($con, $_POST["teamname"]) !== false || teamDataByName($con, $_POST["teamname"])) {
        header("location: ../teams.php?page=requests&error=exists&team=".$_POST["teamname"]);
        exit();
    }
    createRequest($con, $_SESSION["username"], $_POST["teamname"]);
    header("location: ../teams.php?page=requests&error=c&team=".$_POST["teamname"]);
    exit();
