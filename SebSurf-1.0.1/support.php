<?php
 ...
 ?>
    ...
    <div class="main">
        ...
        <p style="color: red;">Dein 'Nickname' wird nur für Cosmetische Zwecke der Website verwendet und kann nicht von anderen Benutzern eingesehen werden, von Administratoren schon!</p>
    </div>
    <div class="main">
