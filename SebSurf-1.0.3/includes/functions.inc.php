      ...
      echo '<div class="main" style="width: 40%;">';
        if (getUserPower($con, $_SESSION["username"]) > 100) {
          ...
          <form action='includes/newsmanager.inc.php' method='post'>
            <button type='submit' name='del' value='".$row["id"]."' style='border:none; font-size: 1.2rem; float: right; margin: 0; width: auto; height: auto; border-radius: 0; padding: 0; position: relative; right: 5px; color: red;'>x</button>
          </form>
          ";
        }
        echo("
          ...
          <p style='color: grey;'>von ".$row['publisher']." (".roleData($con, userData($con, $row['publisher'])['role'])['name'].")</p><br>
        ");
      echo '</div>';
    }
  }
