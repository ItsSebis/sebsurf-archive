    ...
    <div class="nav">
      ...
      <div class="links">
        ...
        if (isset($_SESSION["username"])) {
          ...
          echo '<a href="notifications.php" id="notifies" class="navinotifies">Mitteilungen'.$count.'</a><br><br>';
          echo '<a href="settings.php" id="settings" class="navi">Einstellungen</a><br><br>';
          echo '<a href="includes/logouts.inc.php" class="navilogout">Logout</a><br><br>';
        }
        else {
          echo '<a href="log-in.php" id="login" class="navi">Log in</a><br><br>';
        }
        echo '<br><a href="support.php" id="sup" class="navisupport">Support</a><br><br>';
        ?><br>
        <p style="font-size: smaller; font-weight: 100; color: grey;"><?php echo"Version: 1.0.4"#.currentVersionData($con)["version"] ?></p>
      </div>
    </div>
